...
import { User, Store, Mail, Phone, MapPin, Camera, Save, Package, LayoutDashboard, FileText, LogOut, Menu, X, Edit2, Check } from 'lucide-react';
...
export default function SellerProfile() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100">
            ...
            {/* Footer */}
            <footer className="mt-12 py-6 border-t border-blue-100 bg-white/60 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-600 text-sm">
                    <p>© 2025 Lapak 12. Semua hak dilindungi.</p>
                </div>
            </footer>
        </div>
    );
